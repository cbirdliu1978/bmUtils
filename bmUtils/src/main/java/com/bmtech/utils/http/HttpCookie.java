 ...
 * RFC 2109 -
 * <a href="http://www.ietf.org/rfc/rfc2109.txt"> <i>http://www.ietf.org/rfc/
 * rfc2109.txt</i></a><br>
 * RFC 2965 -
 * <a href="http://www.ietf.org/rfc/rfc2965.txt"> <i>http://www.ietf.org/rfc/
 * rfc2965.txt</i></a> </blockquote>
 *
 * <p>
...
public final class HttpCookie implements Cloneable {
	 ...
	 *            server using only when using a secure protocol; if
	 ...
	 * using any protocol.
	 *
	 * @return <code>true</code> if the browser can use any standard protocol;
	 ...
	 * <blockquote> effective host name = hostname if host name contains dot<br>
	 * &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&
	 ...
	 * path. That is, the hash code is the value of the expression:
	 ...
	 * 
	 * @return <tt>true</tt> if the name is reserved by cookie specification,
	 * <tt>false</tt> if it is not
	 */
	private static boolean isReserved(String name) {
		if (name.equalsIgnoreCase("Comment") || name.equalsIgnoreCase("CommentURL") // rfc2965
																					// only
				|| name.equalsIgnoreCase("Discard") // rfc2965 only
				|| name.equalsIgnoreCase("Domain") || name.equalsIgnoreCase("Expires") // netscape
																						// draft
																						// only
				|| name.equalsIgnoreCase("Max-Age") || name.equalsIgnoreCase("Path") || name.equalsIgnoreCase("Port") // rfc2965
																														// only
				|| name.equalsIgnoreCase("Secure") || name.equalsIgnoreCase("Version") || name.charAt(0) == '$') {
			return true;
		}
	...
	private static void assignAttribute(HttpCookie cookie, String attrName, String attrValue) {
		...
		if (assignor != null) {
			...
			// must be an error
			BmtLogger.instance().log(LogLevel.Error, "Illegal cookie attribute, attrName = '%s', attrValue = '%s'",
					attrName, attrValue);
		}
	}
	 ...
	 * "EEE',' dd-MMM-yyyy HH:mm:ss 'GMT'", which defined in Netscape cookie
	 * spec
	 *
